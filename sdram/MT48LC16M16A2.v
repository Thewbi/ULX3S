...
`define MT48LC16M16   // 32MB part (32MByte * 8Bit/Byte == 256Mbit == 256Mbit part!) (MB == MegaByte, Mb == MegaBit)
...
`endif
   ...
   task get_byte;
     ...
     //$display("SDRAM addr 0x%0h, bank , short 0x%0h, byte 0x%0h", addr, bank, short, data);
      end
   endtask // get_byte
